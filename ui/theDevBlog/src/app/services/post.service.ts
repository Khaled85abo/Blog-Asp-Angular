...
export class PostService {
  ...
  updatePost(id: string | undefined, udpatePostRequest: UpdatePostRequest):Observable<Post> {
    return this.http.put<Post>(this.apiBaseUrl + '/api/posts/' + id, udpatePostRequest);
  }
